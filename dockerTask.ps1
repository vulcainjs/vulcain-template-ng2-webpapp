...
.PARAMETER Clean
Removes the image test-debug-3 and kills all containers based on that image.
...
Build a Docker image named test-debug-3
#>
...
# $imageName="<%=project.namespace %>.<%= project.name %>"
# $projectName="<%= project.name %>"
$imageName="cortex-core.mobile"
$projectName="mobile"
